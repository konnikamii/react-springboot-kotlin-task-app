              ...
              <div className="relative size-full">
                ...
                <div className="relative size-full">
                  <DatePicker
                    ...
                    inputReadOnly
                    status={
                      values.dueDate !== taskData.dueDate ? "warning" : ""
                    }
                ...
                <div
                  className={`pt-[2px] text-sm text-red-600 transition-all duration-300 ${errors.dueDate || errors.global ? "max-h-40" : "max-h-0"} overflow-hidden`}
                >
                  {errors.dueDate ?? errors.global}
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end space-x-4 mt-4">
              <button
                ...
                disabled={
                  ...
                  values.dueDate === taskData.dueDate
                }
                onClick={(e) => {
